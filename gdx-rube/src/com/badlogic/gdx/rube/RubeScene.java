...
/**
 * A simple encapsulation of a {@link com.badlogic.gdx.physics.box2d.World}. Plus the data needed to run the simulation. <br/>
 * It also keep a reference of all created objects ( {@link com.badlogic.gdx.physics.box2d.Body}, {@link com.badlogic.gdx.physics.box2d.Fixture}, {@link com.badlogic.gdx.physics.box2d.Joint}, {@link com.badlogic.gdx.rube.RubeImage} and {@link RubeCustomProperty} ),
...
public class RubeScene {
	...
	/** Box2D {@link com.badlogic.gdx.physics.box2d.World} */
    ...
    protected final Array<Fixture> 						    fixtures;
    protected final Array<Joint> 							joints;
    protected final Array<RubeImage> 						images;
    protected final ObjectMap<Object, RubeCustomProperty>   properties;
    protected final ObjectMap<String, Body> 				bodiesByName;
    protected final ObjectMap<String, Fixture> 			    fixturesByName;
    protected final ObjectMap<String, Joint> 				jointsByName;
    protected final ObjectMap<String, RubeImage> 			imagesByName;
    protected final ObjectMap<Body, Array<RubeImage>> 	    imagesByBody;
	...
	/**
	 * @return all of the {@link com.badlogic.gdx.physics.box2d.Body} created when the scene was loaded.
	 */
	...
	/**
	 * @return all of the {@link com.badlogic.gdx.rube.RubeImage} created when the scene was loaded.
	 */
	...
	/**
	 * @return all of the {@link com.badlogic.gdx.physics.box2d.Fixture} created when the scene was loaded.
	 */
	...
	/**
	 * @return all of the {@link com.badlogic.gdx.physics.box2d.Joint} created when the scene was loaded.
	 */
	...
	/**
	 * @param object the object we want to retrieve the property of. Can be a {@link com.badlogic.gdx.physics.box2d.World}, {@link com.badlogic.gdx.physics.box2d.Body}, {@link com.badlogic.gdx.physics.box2d.Fixture}, {@link com.badlogic.gdx.physics.box2d.Joint} or {@link com.badlogic.gdx.rube.RubeImage}.
	...
	/**
	 * @param body {@link com.badlogic.gdx.physics.box2d.Body} linked to the images.
	 ...
	 * @param world The {@link com.badlogic.gdx.physics.box2d.World} of the scene.
	 ...
	 * @param body The {@link com.badlogic.gdx.physics.box2d.Body} added to the scene.
	...
	/**
	 * Called when a body is added to the scene.
	 * @param fixture The {@link com.badlogic.gdx.physics.box2d.Fixture} added to the scene.
	 ...
	 * @param joint The {@link com.badlogic.gdx.physics.box2d.Joint} added to the scene.
	 ...
	 * @param image The {@link com.badlogic.gdx.rube.RubeImage} added to the scene.
    ...
    /**
     * called when the rube scene is completely loaded
     */
    public void onLoadComplete(){
        Gdx.app.debug("RubeScene", "onLoadComplete");
    }
