...
/**
 * A RubeSprite extends from {@link com.badlogic.gdx.graphics.g2d.Sprite} with additional information to properly follow a {@link com.badlogic.gdx.physics.box2d.Body}
...
public class RubeSprite extends Sprite {
	 ...
	 * @param texture The {@link com.badlogic.gdx.graphics.Texture} to use for the sprite.
	...
	/**
	 * Creates a RubeSprite and setup it with the information in the {@link RubeImage}.
	 * @param region The {@link com.badlogic.gdx.graphics.g2d.TextureRegion} to use for the sprite.
	 * @param imageData Parameters to init and draw the sprite correctly.
	 */
