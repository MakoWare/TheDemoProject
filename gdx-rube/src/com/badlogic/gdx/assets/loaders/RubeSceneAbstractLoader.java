...
/**
 * <p> Loader of {@link RubeScene} for the {@link com.badlogic.gdx.assets.AssetManager}. </p>
 ...
 */
public class RubeSceneAbstractLoader<T extends RubeScene> extends SynchronousAssetLoader<T, RubeSceneAbstractLoader.RubeSceneParameter<T>> {
	
	private final RubeSceneReader<T> reader;
	private final RubeSceneDependenciesReader dependenciesReader;
	private 	  RubeSceneDependencies 	  rubeDependencies;
    private final Class<T> cls;

	public RubeSceneAbstractLoader(Class<T> cls, FileHandleResolver resolver) {
		super(resolver);
        this.cls = cls;
		reader = new RubeSceneReader<T>(cls);
		dependenciesReader = new RubeSceneDependenciesReader();
	}
	
	@Override
	public T load(AssetManager assetManager, String fileName, FileHandle file, RubeSceneParameter parameter) {
	...
	/**
	 * Parameters for the {@link RubeSceneAbstractLoader}
	 * @author clement.vayer
	 */
	static public class RubeSceneParameter<T extends RubeScene> extends AssetLoaderParameters<T> {
