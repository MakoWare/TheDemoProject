 ...
 */
public class MWCamera extends OrthographicCamera {
...
//		Gdx.app.log(tag, "getbounded y");
    ...
    public void resize(boolean yDown, int width, int height){
        this.worldYDown = yDown;
        if(customResize!=null){
            customResize.resize(width,height);
        } else {
            float w = width;
            float h = height;
            if(width <= height)
    ...
    public void resize(int width, int height){
        this.resize(this.worldYDown,width,height);
    }
    ...
    public void setWorldYDown(boolean yDown){
        this.worldYDown = yDown;
        this.resize();
    }
